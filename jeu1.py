...
bckgnd = pygame.image.load("images/plaine.png")

decors = [Sapin(),Sapin(),Sapin(),Sapin(),Sapin(),Sapin(),Rocher(),Rocher(),Rocher(),Rocher(),Rocher(),
Buisson(),Buisson(),Buisson(),Buisson(),Buisson(),Buisson()]

tombes = [Tombe(),Tombe(),Tombe(),Tombe(),Tombe(),Tombe()]
feux = [Feu()]
